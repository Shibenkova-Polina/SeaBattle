...
public class DataBase {
    ...
    public static void clearBD() {
        try {
            ...
            stmt.executeUpdate("DELETE FROM data_base");
    ...
    public static void clearBD_2() {
        try {
            Connection conn = DriverManager.getConnection(url, username, password);
            Statement stmt = conn.createStatement();
            stmt.executeUpdate("DELETE FROM data_base_2");
        } catch (SQLException ex) {
            System.out.println("Cannot connect to DB: " + ex.getMessage());
        }
    }
    ...
    public static void fillBD(int id, String player, StringBuilder states, int i, int shipsKill) {
        ...
        String sql = "INSERT into data_base values(" + id + ", '" + player + "', '" + states + "' , " + i + ")";
    ...
    public static void fillBD_2(int id, String player, int size, int x, int y, String orient) {
        ...
        String sql = "INSERT into data_base_2 values(" + id + ", '" + player + "', '" + data + "' )";
    ...
    public static Map<String, String> getDataHuman() {
        ...
        String sql = "SELECT CellsStates, LineNumber FROM data_base where Player = 'Human'";
        fillData(sql, data);
        return data;
    }
    ...
    public static Map<String, String> getDataComputer() {
        Map<String, String> data = new HashMap<>();
        String sql = "SELECT CellsStates, LineNumber FROM data_base where Player = 'Computer'";
        fillData(sql, data);
        return data;
    }
    ...
    public static String[] getDataHuman_2() {
        ...
        String sql = "SELECT Data FROM data_base_2 where Player = 'Human'";
    ...
    public static String[] getDataComputer_2() {
        String[] data = new String[Field.FIELD_SIZE];
        String sql = "SELECT Data FROM data_base_2 where Player = 'Computer'";
